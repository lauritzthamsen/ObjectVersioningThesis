...
% TODO: explain the difference (decl: function definition that is also a variable decl, function definition were func is only returned from expression)
% TODO: code listings that show the differences..

% function expression that creates an anonymous function: var add = function(a, b) {return a + b};
...
% proxyFor(function add(a,b) {return a + b}) .. function declaration becomes an expression.. it is not available as \lstinline{add} in the surrounding scope
