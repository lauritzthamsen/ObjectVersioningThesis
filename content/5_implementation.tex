...
For example, its \lstinline{get} trap is implemented as shown in Listing~\ref{lst:getTrap}\footnote{The code included in this chapter is simplified. It omits special cases for the workarounds explained in \ref{sec:IMPLEMENTATION:4} and for debugging the implementation. The actual code is available at \url{http://github.com/LivelyKernel/LivelyKernel/commits/50181548}.}.
