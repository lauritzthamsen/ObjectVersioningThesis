...
\subsection{The ECMAScript 6 Proxies}
...
% TODO:    
    ...
    % list of all traps a proxy can have
...
Listing~\ref{lst:test}..

\iffalse
\begin{verbatim}\fi
\begin{code}{CAPTION??}{float,numbers=left}
...
For this, the proxy handler uses a JavaScript object to map version identifiers to the actual versions of the object.
...
\todo{add somehting on \url{http://wiki.ecmascript.org/doku.php?id=harmony:direct\_proxies\#virtual_objects}}
