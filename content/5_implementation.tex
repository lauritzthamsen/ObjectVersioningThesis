...
% TODO:    
    ...
    % examples of other interactions that can be trapped (functions -> apply + construct, enumeration, built-in functions of \lstinline{Object}..), list of possible traps a proxy
    % default behavior: forward interactions unchanged to the target, when trap not implemented
...
% reading other properties would also print statements, 
