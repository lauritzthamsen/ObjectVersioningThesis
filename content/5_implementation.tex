...
This section describes the proxies proposed with the next version of JavaScript's standard~\cite{Ecma2014ES6}.
It also explains how the proxies are used in our implementation.
...
\\
This is also the solution for using the proxies as virtual objects proposed by the official documentation\footnote{\url{http://wiki.ecmascript.org/doku.php?id=harmony:direct\_proxies\#virtual_objects}, accessed May 11, 2014}.
The documentation suggests to use empty objects (\lstinline|{}|) as targets for such virtual object proxies.


\subsection{Proxy Handlers for Object Versioning}
