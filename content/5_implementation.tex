...
It explains the proxy behavior, shows how proxies are inserted using source transformations, and presents implemented workarounds as well as remaining limitations.
