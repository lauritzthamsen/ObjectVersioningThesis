...
\section{Accessing All Mutable JavaScript Objects Through Proxies}
...
Even with disabled consistency checks, the proxies still require actual objects as \emph{target} objects.
