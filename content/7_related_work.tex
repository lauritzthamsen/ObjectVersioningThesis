...
% recovery of previous versions / recovery support: CoExist, Offline Worlds, Back-in-time Debugging

% scoping changes / adaptions: Worlds, Context-oriented Programming, Lienhard-Aliases
