...
The state of such an \emph{address} object could be as shown in Figure~\ref{fig:SingleObject}\footnote{The figures in this chapter use the notation of \ac{uml} object diagrams. Extensions are explained in the figures.}.
