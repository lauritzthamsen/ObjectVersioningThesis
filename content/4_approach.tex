...
With our approach, specific versions, not every state the system ever has been in, are preserved.
Which versions exactly is not inherent to our approach.
...
% even though proxies, should still be transparent to programmers, should be provided by the system
