...
% state of the complete runtime, including state of the runtime that is not persisted with commiting particular objects or entire Lively worlds (global variables.. config..).. and that, in Lively, classes are also objects and, thus, also preserved
