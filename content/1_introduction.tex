...
% Solution
For similar recovery support in programming systems like Lively, we propose object versioning to be able to preserve and re-establish versions of the programming runtime.
