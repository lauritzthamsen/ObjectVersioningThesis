...
Logging-based approaches, Replay-based approaches \todo{see Lienhard2008POB}.. both to recreate a particular state of the runtime... but purpose is debugging and not necessarily recovering.. 
...
Johnson and Duggan’s GL programming language \todo{gl? (related to Worlds..)}
Morrisett sub-stores 

Tanter's scoped assignment construct  that enables programmers to control the scope of side effects \todo{scoped assignments? (related to Worlds..)}
