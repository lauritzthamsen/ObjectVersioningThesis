...
% a few typical user interactions in the Lively Kernel, and also how much longer it takes to load a Lively Kernel world with source transformations and version-aware references.
