...
For these tests, we used the computer described in this section and the Chrome browser.
...
Octane is a general JavaScript benchmark suite that consists of eight benchmarks and makes use of many important language features, including primitive data types, operators, built-in functions, custom functions, objects, and prototypical inheritance.
It advertises itself as providing tests that are representative of modern Web applications.
Octane is also used in measuring the performance of \emph{v8}, the engine used by the Chrome browser and Node.js, and even part of its official source code repository\footnote{\url{http://v8.googlecode.com/svn/}, accessed April 23, 2014, at revision 20901}.
